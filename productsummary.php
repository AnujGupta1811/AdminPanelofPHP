...
<html>
	...
	<!-- maincontainer1 goes here -->
		...
		<div class="section1">
			...
			<p class="clickhere">click here to <a href="">create</a> New Product</p>
			<form>
			<table class="logintable2">	
				...
				<tr>
					<td><b>Search by Product Name:</b></td>
		...
		?>
			...
			<tr>
				...
				<td><img width="50" height="50" src="uploadimages/<?php echo $row['pimage'] ?>"/></td>
				<td><a href="productadd.php?eid=<?php echo $row['id']?>">
				<img src="images/pht1.jpg"/></a>
				</td>
				<td><a href="productsummary.php?did=<?php echo $row['id']?>">
				Delete</a></td>
			</tr>
		<?php } ?>
			<tr>
